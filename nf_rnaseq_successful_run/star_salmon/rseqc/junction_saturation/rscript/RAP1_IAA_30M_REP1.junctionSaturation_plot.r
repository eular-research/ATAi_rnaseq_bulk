...
y=c(1,2,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3)
z=c(7,11,17,22,25,28,32,34,38,43,47,50,52,52,56,58,60,60,62,63)
w=c(6,9,14,19,22,25,29,31,35,40,44,47,49,49,53,55,57,57,59,60)
m=max(0,0,0)
n=min(0,0,0)
